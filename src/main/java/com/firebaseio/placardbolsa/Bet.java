...
public class Bet {
    ...
    public Bet(String bet_index, String Date, String bet_price, Object games, String game_number, String projected_winnings, String general_betType, Object result, Object votes) {
        this.Date = Date;
